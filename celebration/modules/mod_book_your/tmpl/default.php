...
<script>
function srShow(companyname,address,city,phone){
...
<div id="buttons">
<div id="s_submit_btn"><input src="images/s_nd.png" alt="send" type="image" name="submit" id="kemail"><input type="hidden" name="submit"></div>
...
<div class="box1" style="margin-left: 22px; margin-top: 14px;">
...
<div class="looksubmitbtn"><input src="images/submit_button.png" value="Submit" id="look" border="0" name="query" type="image"><input type="hidden" name="query">
...
<div class="msg_img_one"><a id="showsr" onClick="return srShow('<?php echo $listing->companyname; ?>','<?php echo $listing->address; ?>','<?php echo $listing->city;?>','<?php echo $listing->phone; ?>');"   style="cursor: pointer;"><img src="images/mail_blue_img.jpg"></div>
...
?>
<script type="text/javascript">
function showv(companyname,address,city,phone){
...
<div class="box1" style="margin-left: 70px; margin-top: 20px;">
...
<div class="clickbtntwo"><a id="showvs" onClick="return showv('<?php echo $item->companyname; ?>','<?php echo $item->address; ?>','<?php echo $item->city;?>','<?php echo $item->phone; ?>');"  style="cursor: pointer;"><img src="images/sms_mail.gif"></a></div>
