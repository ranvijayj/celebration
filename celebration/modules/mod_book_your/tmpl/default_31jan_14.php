...
<form method="post" name="jas">
 ...
 <input type='text'  id='sms_companyname3' name='sms_companyname3' >
      <input type='text'  id='sms_address3'name='sms_address3' >
      <input type='text'  id='sms_city3' name='sms_city3'>
      <input type='text'  id='sms_phone3' name='sms_phone3'>
<div id="sms_cont">Send Email</div>
<div id="gt_logo"><img src="images/gt_loto.png" alt=""></div>
...
<form method="post" name="jsp" action="" onSubmit="return validateEnquiryy();">
        ...
        <input type='text'  id='sms_companyname4' name='sms_companyname4' >
      <input type='text'  id='sms_address4'name='sms_address4' >
      <input type='text'  id='sms_city4' name='sms_city4'>
      <input type='text'  id='sms_phone4' name='sms_phone4'>
