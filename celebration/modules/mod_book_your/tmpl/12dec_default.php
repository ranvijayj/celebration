<div style="padding: 0px 0px 0px 99px"> From Luxury Hotels to Budget Accommodations, you get India’s best hotel listing for hotel rooms here. Find your choice of hotel for a most interesting and spellbinding trip</div>
...
function ci()
    {
	  var cat=document.getElementById('dest').value;
	   window.location="http://diwali.getit.in/index.php/book-your-hotel?dest="+cat;
...
$mailer->setSubject('posted a Query on celebartion.getit.in');
$mailer->setBody($body);
$send =& $mailer->Send();
if ( $send !== true ) {
    echo 'Error sending email';
