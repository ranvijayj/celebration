...
$sql = "select * from #__k2_items where catid='4' and published='1' limit 0,2";
$db->setQuery($sql);
$row = $db->loadAssocList(); 
?>

<div class="receipe">
	<div class="rBlock">Top Receipe<!--<span class="view_all" style="font-size:11px;padding-left:130px; margin: 0px 0px 0px 0px; "><a href="index.php/top-receipe" >View more </a></span>--></div>
	...
	<?php }else{?><a href="index.php/top-recipes/item/<?php echo $val['id']."-".$val['title']; ?>"><img src="images/no_image.jpg" width="109" height="63"></a><?php }?>
			...
			<p> <a href="index.php/top-receipe/item/<?php echo $val['id']."-".$val['title']; ?>">more</a></p>
		   </li>
