<div style=" margin-top:15px;" >Car hire, car rental and taxi services for local and outstation travel in India. Car Rental in India available for luxury cars, mini vans, buses and large coaches on hire. </div>
...
<script>
function smShow(companyname,address,city,phone){
...
function queryShow(companyname,address,city,phone){
...
<div id="buttons">
<div id="s_submit_btn"><input src="images/s_nd.png" alt="send" type="image" name="submit" id="semail"><input type="hidden" name="submit"></div>
<div id="c_lose_btn"><img src="images/c_losed.png" alt="close" type="image" onClick="smClose()"></div>
</div>
</div>
</form>
</div>
...
<div class="box_titles"><a id="snmShow" onClick="return smShow('<?php echo $listing->companyname; ?>','<?php echo $listing->address; ?>','<?php echo $listing->city;?>','<?php echo $listing->phone; ?>');"  style="cursor: pointer;"> Send Email</a></div>
<div class="msg_img"><a id="qShow" style="cursor: pointer;" onClick="queryShow('<?php echo $listing->companyname; ?>','<?php echo $listing->address; ?>','<?php echo $listing->city;?>','<?php echo $listing->phone; ?>');"><img src="images/send_enquiry_blue_img.jpg"></div>
...
$(document).ready(function() {
	var n1 = Math.round(Math.random() * 10 + 1);
    var n2 = Math.round(Math.random() * 10 + 1);
    document.getElementById("aook").innerHTML=(n1 + " + " + n2 + " =" );
	
    $("#vali").click(function() {


var chech_status=validatsms();
if(!chech_status)
{
...
<div class="box1" style="margin-left: 70px; margin-top: 80px;">
<div id="aook"  style="font-size:32px; float:left; font-family:'Courier New', Courier, monospace; font-style:italic;" ></div>
<div style="float:left; padding:3px 0px 0px 5px;"><input type="text" id="book"  name="answer" style="font-size:32px; margin-top: -9px; height:32px; width:60px" maxlength="3"/></div>

</div>
<div class="clr"></div>
<div id="buttons">
<div id="s_submit_btn"><input src="images/s_nd.png" alt="send" type="image" name="submitt" id="vali"><input type="hidden" name="submitt"></div>
...
$(document).ready(function() {
	var n1 = Math.round(Math.random() * 10 + 1);
    var n2 = Math.round(Math.random() * 10 + 1);
    document.getElementById("aank").innerHTML=(n1 + " + " + n2 + " =" );
	
    $("#come").click(function() {


var chech_status=validateEnquiryy();
if(!chech_status)
{
...
<div class="clr"></div>
<span style="margin-left:13px;"> *All fields are mandatory. </span>
<form method="post" name="jsp" action="">
...
<div class="box1" style="margin-left: 20px; margin-top: 20px;">
<div id="aank"  style="font-size:32px; float:left; font-family:'Courier New', Courier, monospace; font-style:italic;" ></div>
<div style="float:left; padding:3px 0px 0px 5px;"><input type="text" id="bank"  name="answer" style="font-size:32px; margin-top: -9px; height:32px; width:60px" maxlength="3"/></div>

</div>

<div class="looksubmitbtn"><input src="images/submit_button.png" value="Submit" id="come" border="0" name="query" type="image"><input type="hidden" name="query">
...
var ct=document.forms["comm"]["Message"].value;
if (ct==null || ct=="" || ct=="enter your message here...")
  {
  alert("Query cannot be empty");
  document.forms["comm"]["Message"].focus();
  return false;
  }
  return true;
}
...
$(document).ready(function() {
	var n1 = Math.round(Math.random() * 10 + 1);
    var n2 = Math.round(Math.random() * 10 + 1);
    document.getElementById("aote").innerHTML=(n1 + " + " + n2 + " =" );
	
    $("#lookped").click(function() {


var chech_status=validateComment();
if(!chech_status)
{
...
<form method="post" name="comm" action="">
...
<div class="box1">
<div id="aote"  style="font-size:32px; float:left; font-family:'Courier New', Courier, monospace; font-style:italic;" ></div>
<div style="float:left; padding:3px 0px 0px 5px;"><input type="text" id="bote"  name="answer" style="font-size:32px; height:32px; width:60px" maxlength="3"/></div>
  ...
  <div class="submit_comment"><input type="image" src="images/submit_button.png" name="comment" id="lookped"/><input type="hidden" name="comment"></div>
