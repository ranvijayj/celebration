...
//foreach($xml->children() as $i => $child){
        $dealsArr='
        <div class="deal_title">title</div>
        <div class="deal_img">
            <a href="http://hotdeals.getit.in/latest/">
            <img id="imgDeals" style="border:0px;" width="163" height="60" src="img.png" /></a>
        </div>
        <div class="deal_desc">dddddddddyyyyy ttttttd gdgdfg fgh d gfd..</div>
