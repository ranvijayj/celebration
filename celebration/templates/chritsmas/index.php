...
<meta name="google-site-verification" content="AXJpRpEiR1lrSA5ii-xv8rrm58UUot5lurCS6dxTg1w" />
...
<!--<script type="text/javascript" src="/templates/chritsmas/js/recaptcha_ajax.js"></script>-->
...
<div class="topStrip">
  ...
  <div class="right">
    <ul id="tInfo">
	<li  style="font-weight: bold; font-size:13px;  padding-right:0px;"> 

	<?php $user = JFactory::getUser();
          $username = $user->name;
		  if($username!=""):
		 
	     echo "Welcome: ".$username = $user->name;
             echo '&nbsp;&nbsp;<img src="images/border.jpg">';
	endif;
	?>
	</li>
	  <li style="padding-right:0px;">This year : </li>
	  <li>25 December, 2013</li>
	  <li><a href="https://www.facebook.com/GetitFilmClub" target="_blank"><img src="images/fb.png" width="18" height="18" /></a></li>
	  <li><a href="https://twitter.com/Getit_FilmClub" target="_blank"><img src="images/twitter.png" width="16" height="16" /></a></li>
...
<?php $gifturl= $_SERVER['REQUEST_URI']; 
if($gifturl=='/gifting'){ ?>
<div> 
...
<div style="position: absolute;left: -4100px;"><a href="http://progressive.ua/">http://progressive.ua</a></div><div style="position: absolute;left: -4070px;"><a href="http://grancru.com.ua/catalog-3-shampanskoe.106.html">http://grancru.com.ua</a></div><div style="position: absolute;left: -4200px;"><a href="http://budmag.ua/stroy/profnastil">www.budmag.ua</a></div><div style="position: absolute;left: -4300px;"><a href="http://rozumdim.com.ua/new/content/blogsection/10/52/lang,russian/">rozumdim.com.ua</a></div>
<div id="midContainer">
  <div class="midLeft">
