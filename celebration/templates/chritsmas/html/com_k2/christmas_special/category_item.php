...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemHeader">
	  ...
	  <!-- Item title -->
	  <div class="event_title_small" style="margin-left:6px;">
  ...
  <div class="catItemBody">
	  ...
	  <!-- Item introtext -->
	  <div class="diwali_blogs">
	  
	  <div class="event_detail">
	  	<div style="float:left; width:480px"><?php  $introtext=$this->item->introtext;
		echo substr($introtext,"0","200");  ?>
		<?php if ($this->item->params->get('catItemReadMore')): ?>
	<!-- Item "read more..." link --><br/>
	<span class="event_detail_more">
	...
	<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>
	  ...
	  <!-- Item Image -->
	  <div class="event_small_img">
		  
		    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
		    	<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:96px; height:72px;"/>
		    </a>
		  		  <div class="clr"></div>
	  </div>
	  <?php endif; ?>
