...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader" style="padding:20px 0px 0px 0px">
	 ...
	 <h1 >
			...
			<span class="itemEditLink">
				<a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->params->get('page_title'); ?>">
					<?php echo JText::_('K2_EDIT_ITEM'); ?>
				</a>
			</span>
			<?php endif; ?>
			
			<?php $page_heading=$this->item->params->get('show_page_heading');
if($page_heading=='1'){
 echo $this->item->params->get('page_heading');}
else { echo $this->item->title; }?>
...
<div class="event_content_img">
	  ...
	  <!-- Item Image -->
		  	...
		  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
		  		<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:154px; height:154px; padding:0px 8px 7px 0px" align="left" />
</a>
<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('Click to expand'); ?>" style="position:absolute; margin:133px 0px 0px -26px;"><img src="images/zoom_in.png"/></a>
...
<?php endif; ?>
	  ...
	  <?php else: ?>
	  <!-- Item text -->
	   <div class="event_content" style="margin-top:2px; width:600px;">
