...
.box_comment_detail{  margin-left:0px; margin-top:8px; margin-bottom:10px;  font:  13px Tahoma, Geneva, sans-serif; color:#000; float:left; width:115px; text-align:right;}
...
<div class="share_text"><?php if($this->item->params->get('itemTitle')): ?>
	  <!-- Item title -->
	  <div class="itemTitle" style="padding:0px 0px 0px 10px; margin:0px; font-size:20px; font-family:HelveticaLT Compressed; font-weight:bold; color:#000;">
...
<div class="detail_texts_blue">upload by : <?php echo $this->item->author->name; ?>, <?php if($this->item->params->get('itemDateCreated')): ?>
		<!-- Date created -->
...
<div class="share_msg_img"><img src="images/twitter_share.jpg" /></div>
<div class="share_msg_img"><img src="images/fb_share.jpg" /></div>
</div>
<div class="clr"></div>
</div>
