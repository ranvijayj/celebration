 ...
 <li style="border-right:solid 1px #000;padding-right:5px;line-height:10px;">Rate it</li>
	<li><a href="#review" style="text-decoration:none;color:#244FA7; ">write a review</a></li>
	  ...
	  <?php endif; ?>
		...
		<br/>
  <ul class="psSocial">
    <li><a href="https://twitter.com/share" data-count="none" data-url="<?php echo $this->item->link; ?>" class="twitter-share-button"  data-dnt="true">Tweet</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></li>


	<li><div class="fb-like" data-send="false" data-layout="button_count" data-href="<?php echo $this->item->link; ?>" data-width="450" data-show-faces="true"></div></li>
