...
#midContainer .midLeft .gBlock{width:599px;background:#a20208;height:31px;font-size:18px;font-weight:normal;color:#fff;line-height:31px;border-left:5px solid #000;text-indent:5px;margin:13px 0 0 0;}
#midContainer .midLeft .gBlock span{float:right;font-size:11px;margin-right:10px;}

#midContainer .midLeft .tBlock{width:599px;background:#038916;height:31px;font-size:18px;font-weight:normal;color:#fff;line-height:31px;border-left:5px solid #000;text-indent:5px;margin:13px 0 0 0;}
#midContainer .midLeft .tBlock span{float:right;font-size:11px;margin-right:10px;padding-top:4px;height:20px;}

#midContainer .midLeft .ptBlock{width:599px;background:#a20208;height:31px;font-size:18px;font-weight:normal;color:#fff;line-height:31px;border-left:5px solid #000;text-indent:5px;margin:13px 0 0 0;}
#midContainer .midLeft .ptBlock span{float:right;font-size:11px;margin-right:10px;height:20px;}

.psBlock{width:605px;padding:0 0 12px 0;margin-top:14px;}
.psBlock .psIcon{float:left;margin-right:10px;}
.psBlock .psData{width:340px;float:left;}
.psData h4{font-size:12px;font-weight:bold;color:#244fa7;}
.psBlock .psData li{display:inline-block;font-family:tahoma;font-size:11px;color:#244fa7;padding-top:2px; vertical-align:middle;}
.psBlock .psData li span{color:#e85b03;}
.psBlock .psData li:last-child{background:url(../Images/divider.jpg) left bottom no-repeat;padding-left:4px;}
.psBlock .psData p{font-family:tahoma;font-size:11px;color:#000;padding-top:5px;}
.psBlock .psData ul.psSocial{}
.psBlock .psData ul.psSocial li{font-family:tahoma;font-size:11px;color:#000;text-align:top;background:none;padding-right:0px;}
.psBlock .psData ul.psSocial li span{font-family:tahoma;font-size:11px;color:#000;font-style:italic}
.psBlock .psData ul.psSocial li:last-child{padding-left:6px;}

.rivew{width:98%;padding-bottom:14px;margin-top:6px;border-bottom:dashed 1px #d1cece;}
.rivew p{color:#a20208;font-family:Tahoma;font-weight:bold;font-size:11px;padding:0 0 0 10px;}
.rivew p+p{color:#000;font-family:Tahoma;font-weight:normal;font-size:11px;}
.rivew p+p span{color:#6b6f64;}
...
?>
   ...
   <div class="ptBlock">Share your Photos</div>
...
<div class="psBlock">
  <div class="psIcon"> <?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
	  <!-- Item Image -->
...
<div class="psData">
  <h4>
	  ...
	  <?php endif; ?>
	   ...
	   <ul>
    <li><?php if($this->item->params->get('itemRating')): ?>
	<!-- Item Rating -->
 ...
 <li style="border-right:solid 1px #000;padding-right:5px;line-height:10px;">Rate it</li>
	<li><a href="#review" style="text-decoration:none;color:#244FA7; ">write a review</a></li>
  </ul>
	  ...
	  <?php endif; ?>
		...
		<br/>
  <ul class="psSocial">
    <li><a href="https://twitter.com/share" class="twitter-share-button" data-count="none"  data-dnt="true">Tweet</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></li>
	<li><div class="fb-like" data-href="http://celebration.getit.in/index.php/share-your-moment/item/<?php echo $this->item->id;?>-<?php echo $this->item->alias;?>" data-send="false" data-layout="button_count" data-width="450" data-show-faces="true"></li>
	<!--<li><img src="Images/share-photos.jpg" width="94" height="23" /></li>
 --> </ul>
  </div>
  <div class="flexi"></div>
</div>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="itemComments" id="review">
