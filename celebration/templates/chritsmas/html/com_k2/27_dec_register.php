...
function validation()
{
	...
	return false;
		...
		if(!re.test(name))
		{
		alert('Please Enater Valid Name.');
		document.getElementById('name').focus();
		document.getElementById('name').value="";
		return false;
		}
	...
	{
		alert("please enter sameas email");
...
<a href="/celebrat/" class="pathway">Home</a> <img src="/celebrat/media/system/images/arrow.png" alt=""> <span>User Register</span></div>
