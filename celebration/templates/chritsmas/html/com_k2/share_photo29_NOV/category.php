...
<div id="k2Container" style="margin:0px; padding:0px;" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<!-- Category block -->
		<div class="itemListCategory" style="margin-left:10px; padding:0px; background:none; border:0px;">
			...
			<!-- Category title -->
			<div style="padding:0px; margin:0px; font-size:20px; font-family:HelveticaLT Compressed; font-weight:bold; color:#000;"><?php echo $this->category->name; ?><?php if($this->params->get('catTitleItemCounter')) echo ' ('.$this->pagination->total.')'; ?></div>
			<?php endif; ?>
