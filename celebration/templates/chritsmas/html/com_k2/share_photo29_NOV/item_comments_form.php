...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" id="comment-form" class="form-validate">
	...
	<div class="box_field_detail" style="margin-top:14px;"><textarea  class="comment_txt" onblur="if(this.value=='') this.value='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>';" onfocus="if(this.value=='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>') this.value='';" name="commentText" id="commentText" style="font-weight:normal; font-size:12px; color:#000;"><?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?></textarea></div>
	<div class="clr"></div>
	...
	<div class="box_field_detail" style="margin-top:18px;">	<input class="box_input_detail" type="text" name="userName" id="userName" value="<?php echo JText::_('K2_ENTER_YOUR_NAME'); ?>" onblur="if(this.value=='') this.value='<?php echo JText::_('K2_ENTER_YOUR_NAME'); ?>';" onfocus="if(this.value=='<?php echo JText::_('K2_ENTER_YOUR_NAME'); ?>') this.value='';" />
</div>
	<div class="clr"></div>
	...
	<div class="box_field_detail" style="margin-top:14px;">	<input class="box_input_detail" type="text" name="commentEmail" id="commentEmail" value="<?php echo JText::_('K2_ENTER_YOUR_EMAIL_ADDRESS'); ?>" onblur="if(this.value=='') this.value='<?php echo JText::_('K2_ENTER_YOUR_EMAIL_ADDRESS'); ?>';" onfocus="if(this.value=='<?php echo JText::_('K2_ENTER_YOUR_EMAIL_ADDRESS'); ?>') this.value='';" />
  ...
  <div class="reset" style="float:left; margin:8px 0 0 18px;"><img src="images/reset_button.jpg" /></div>
  <div class="clr"></div>
