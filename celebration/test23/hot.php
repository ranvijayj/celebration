...
$client = new SoapClient("http://119.226.135.78/hotdealswebservice/hotdealsservice.asmx?WSDL"); 
...
foreach($cit as $child){
 ...
 $dealsArr[]="<div class='hot_deal_container'><div class='hot_deal_img'><a href='http://getithotdeals.in/' target='_blank'><img src=http://getithotdeals.in/image/getFirstImage/".$child['DealID']." style='width:143px;height:86px;' alt='' /></a></div>
<div class='hot_deals_texts'>
<a href='http://getithotdeals.in/' target='_blank'>".$child['Title']."</a></div>
</div>
<div class='hot_deal_btn'><a href='http://getithotdeals.in/' target='_blank'><img src='http://onam.getit.in/images/hot_deals_btn.jpg' border='0'/></a></div>
<div class='visit_link'><a href='http://getithotdeals.in/' target='_blank'>visit getithotdeals.in</a></div>
</div>
