...
function ci()
    {
	 ...
	 window.location="<?php echo Juri::base(true).'/index.php/shopping?view=shopping&what=shopping&cat='.$cat.'&subcat='.$subcat.'&where=';?>"+cat;
...
<li>Prev</li>
<?php else: ?>    
<li><a href="<?php echo $this->_paginationUrl.'0' ?>">First</a></li>
<li><a href="<?php echo $this->_paginationUrl.'0' ?>">Prev</a></li>
<?php endif; ?>    
<?php for($i=1;$i<10;$i++){ ?>
...
<li>Last</li>
<?php else: ?>    
<li><a href="<?php echo $this->_paginationUrl.'9' ?>">Next</a></li>
<li><a href="<?php echo $this->_paginationUrl.'9' ?>">Last</a></li>
<?php endif; ?>   
</ul>
</div>
