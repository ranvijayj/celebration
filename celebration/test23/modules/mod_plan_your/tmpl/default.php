...
function ci()
    {
	  var cat=document.getElementById('dest').value;
	   window.location="http://diwali.getit.in/index.php/plan-your-trip?dest="+cat;
...
<div class="msg_img_one"><a id="showSmsPop2" onClick="return ShowSms();" style="cursor:pointer;">
<img src="images/mail_blue_img.jpg"></div>
<div class="box_titles">SMS/Email</a></div>
<div class="msg_img"><a id="showEmailPop" onClick="return ShowEmail();" style="cursor:pointer;">
