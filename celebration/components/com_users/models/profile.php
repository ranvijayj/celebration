...
class UsersModelProfile extends JModelForm
{
	...
	$ext = substr($fileName,strrpos($fileName,'.')+1);
	 if ($fileName && !(($ext == "jpg" || $ext == "gif" || $ext == "png") && ($_FILES["image"]["type"] == "image/jpeg" || $_FILES["image"]["type"] == "image/gif" || $_FILES["image"]["type"] == "image/png") && ($_FILES["image"]["size"] < 1120000))){//echo 'dsbndsbj';die;
