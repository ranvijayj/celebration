...
dd.message ul li{margin-top:10px;}
</style>
<?php
/**
 * @package		Joomla.Site
...
<div class="remind<?php echo $this->pageclass_sfx?>">
	...
	<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" onsubmit="return info();">
<fieldset><?php if ($this->params->get('show_page_heading')) : ?>
	<h1 style="margin: 5px 0px 9px 8px;">Forget your Username
	</h1>
	<?php endif; ?>
		...
		<?php endforeach; ?>
		<div>
		<div class="login_button_btn" style="margin:20px 0px 0px 230px;">
