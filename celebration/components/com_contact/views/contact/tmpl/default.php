...
var chech_status=displaymessage();
if(!chech_status)
{
...
<div class="contect_num">GYS Heights, Plot-10 & 11 2nd & 3rd floor Tower-C, Sector-125 Noida, Uttar Pradesh Pincode:201301, India </div>
</div>
		...
		<fieldset style="border:none;"> 
			...
			<dl>
				...
				<div class="inptut"><?php echo $this->form->getInput('contact_message'); ?></div>
							<style>
.box1{margin: 16px 0px 0px 20px; height:40px; width:230px; }
</style>
<div class="box1">
...
<div style="float:left; padding:3px 0px 0px 5px;"><input type="text" id="b"  name="answer" style="font-size:32px; height:32px; margin-top: -9px; width:60px" maxlength="3" /></div>
			...
			<?php //Dynamically load any additional fields from plugins. ?>
			     ...
			     <?php endforeach;?>
				<dt></dt>
				<dd><button class="button validate" type="submit" id="cont"  name="task"  style="background:#000000; padding:5px; color:#FFFFFF"><?php echo "Submit" ?></button>
