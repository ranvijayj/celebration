 ...
 <form method="post" action="<?php echo JRoute::_("index.php?option=com_odudecard&amp;controller=odudecardpre&amp;Itemid=$mymenuitem");?>" id='myForm' class="form-validate" onSubmit="return myValidate(this);">
  ...
  <tr align="left">
    <td colspan="2">  <B<BR><BR>
        ...
        <input type="submit" name="button2" id="button2" value="<?php echo JText::_('COM_ODUDECARD_ECARD_SEND_ECARD_FIRST'); ?>" class=button />
        <a href=http://www.odude.com target=_blank ><img src="<?php echo JURI::base(); ?>components/com_odudecard/include/dot.gif" border=0 align=right></a>
      </label>
    </form>
