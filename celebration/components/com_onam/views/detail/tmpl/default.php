...
<div id="s_submit_btn"><input src="images/s_nd.png" alt="send" type="image" name="submit" id="vali"><input type="hidden" name="submit"></div>
...
$(document).ready(function() {
	var n1 = Math.round(Math.random() * 10 + 1);
    var n2 = Math.round(Math.random() * 10 + 1);
    document.getElementById("alank").innerHTML=(n1 + " + " + n2 + " =" );
	
    $("#jhjkss").click(function() {
...
<form method="post" name="js" action="">
...
<div id="alank"  style="font-size:32px; float:left; font-family:'Courier New', Courier, monospace; font-style:italic;" ></div>
<div style="float:left; padding:3px 0px 0px 5px;"><input type="text" id="blank"  name="answer" style="font-size:32px; margin-top: -9px; height:32px; width:60px" maxlength="3"/></div>

</div>


<div class="looksubmitbtn"><input src="images/submit_button.png" value="Submit" border="0" name="query" id="jhjkss" type="image"><input type="hidden" name="query">
