...
$recipient=array($_POST[commentEmail],'navratri@getit.co.in');
...
<div class="userrev_boxmid">User Review <span class="writerev"><a href="#">Write a review</a></span> <span class="revdroparrow"><img src="images/green_arrow.png"></span></div>
