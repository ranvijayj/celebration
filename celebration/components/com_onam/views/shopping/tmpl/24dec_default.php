...
$mailer->setSender($_POST['Email'],"satyendra.yadav84@gmail.com");
...
<div id="s_submit_btn"><input src="images/s_nd.png" alt="send" type="image" name="submit" onClick="return validatesms();">
...
<div class="featured_title"> Result <?php ?></div>
